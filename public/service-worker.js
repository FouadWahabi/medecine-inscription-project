        ...
        5: [function (require, module, exports) {
            ...
            ["get", "post", "put", "delete", "head", "any"].forEach(function (e) {
                ...
                for (var o = 0; o < t.length; o++) {
                    ...
                    if (u) {
                        var a = keyMatch(u, r);
                        if (a.length > 0)return a[0].makeHandler(r)
                    }
                }
                return null
        ...
        14: [function (require, module, exports) {
            function parse(e) {
                for (var t, r = [], n = 0, o = 0, a = ""; null != (t = PATH_REGEXP.exec(e));) {
                    ...
                    if (a += e.slice(o, s), o = s + p.length, i)a += i[1]; else {
                        ...
                        if ("string" != typeof c) {
                            ...
                            if (isarray(l)) {
                                ...
                                for (var f = 0; f < l.length; f++) {
                                    if (u = i(l[f]), !t[s].test(u))throw new TypeError('Expected all "' + c.name + '" to match "' + c.pattern + '", but received `' + JSON.stringify(u) + "`");
                                    o += (0 === f ? c.prefix : c.delimiter) + u
                                }
                            } else {
                                if (u = c.asterisk ? encodeAsterisk(l) : i(l), !t[s].test(u))throw new TypeError('Expected "' + c.name + '" to match "' + c.pattern + '", but received "' + u + '"');
                                o += c.prefix + u
                            }
                        } else o += c
                    }
